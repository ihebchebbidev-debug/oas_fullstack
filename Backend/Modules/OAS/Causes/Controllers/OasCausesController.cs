...
public class OasCausesController : OasControllerBase
{
    ...
    [HttpPut("{id}/kind")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpPut("{id}/criticality")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpPost("{id}/children")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpDelete("{id}/children/{childId}")] [OasAuthorize(Roles = "admin,supervisor")]
...
public class OasCauseProposalsController : OasControllerBase
{
    ...
    [HttpPost("{id}/review")] [OasAuthorize(Roles = "admin,supervisor")]

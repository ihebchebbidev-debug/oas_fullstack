...
public class OasPostsController : OasControllerBase
{
    ...
    [HttpPut("{id}/attributes")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpPut("{id}/critical")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpPost("{id}/qr-token/rotate")] [OasAuthorize(Roles = "admin,supervisor")]
    ...
    [HttpPut("layout")] [OasAuthorize(Roles = "admin,supervisor")]

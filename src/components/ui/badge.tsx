...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 text-badge leading-none transition-colors focus:outline-none focus:ring-1 focus:ring-ring/50 focus:ring-offset-1",
  {
    variants: {
      variant: {
